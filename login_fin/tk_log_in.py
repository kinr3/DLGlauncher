...
class FrameOne(tk.Frame):
    ...
    def __init__(self, parent, cotroller):
        ...
        self.text_PASSWORD = ttk.Label(self, textvariable=self.pass_v, background='black', foreground='white',
                                       font=LARGE_FONT)
        self.text_ANMELDEN = ttk.Label(self, text='                   ANMELDEN       ~'+online+'~     ',
                                       background='black', foreground='white', font=LARGE_FONT)

        self.button_img_pass = tk.Button(self, image=image['DLG_Pass_v.png'], background='black', command=self.
                                         pass_button, border=0)
...
class FrameThee(tk.Frame):
    ...
    def __init__(self, parent, cotroller):
        ...
        self.text_EMAI = ttk.Label(self, textvariable=self.name_v, background='black', foreground='white',
                                   font=LARGE_FONT)
        self.text_NAME1 = ttk.Label(self, text='Name:', background='black', foreground='white', font=LARGE_FONT)
        self.text_NAME2 = ttk.Label(self, text='NachName:', background='black', foreground='white', font=LARGE_FONT)
        self.text_PASSWORD = ttk.Label(self, textvariable=self.pass_v, background='black', foreground='white',
                                       font=LARGE_FONT)
        ...
        self.tbx_name1 = tk.Entry(self, textvariable=self.tbx_name1_v, width=20, font=TBX_FONT, background='black',
                                  foreground='white')
        self.tbx_name2 = tk.Entry(self, textvariable=self.tbx_name2_v, width=20, font=TBX_FONT, background='black',
                                  foreground='white')
        ...
        self.button_img_agb_box = tk.Button(self, image=image['DLG_Register_agb.png'], background='black', command=self
                                            .agb_button, border=0)
        self.button_img_age_box = tk.Button(self, image=image['DLG_Register_16.png'], background='black', command=self.
                                            age_button, border=0)
        self.button_log_in = tk.Button(self, image=image['DLG_Register_back.png'], background='black', command=self.
...
class FrameZero(tk.Frame):
    ...
    def __init__(self, parent, cotroller):
        ...
        self.progress.start()
        thread = threading.Thread(target=self.first_concat)
        thread.daemon = True
        thread.start()
